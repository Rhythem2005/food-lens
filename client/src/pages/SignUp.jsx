...
const GLOW_ORBS = [
  { id: 1, color: "rgba(255, 107, 44, 0.12)", size: 450, x: "85%", y: "15%", duration: 25 },
  { id: 2, color: "rgba(180, 127, 255, 0.08)", size: 380, x: "15%", y: "75%", duration: 20 },
  { id: 3, color: "rgba(255, 209, 102, 0.06)", size: 300, x: "50%", y: "50%", duration: 30 },
];

const FLOATING_FOOD = [
  { id: 1, emoji: "🍕", size: 44, x: "12%", y: "22%", duration: 16, delay: 0 },
  { id: 2, emoji: "🍔", size: 36, x: "85%", y: "20%", duration: 14, delay: 1 },
  { id: 3, emoji: "🥗", size: 42, x: "74%", y: "82%", duration: 18, delay: 2 },
  { id: 4, emoji: "🍛", size: 34, x: "10%", y: "76%", duration: 15, delay: 0.5 },
  { id: 5, emoji: "🍣", size: 38, x: "90%", y: "55%", duration: 20, delay: 3 },
  { id: 6, emoji: "🍰", size: 36, x: "8%", y: "45%", duration: 17, delay: 1.5 },
];
        ...
        >
          ...
          <div style={{
            ...
            <p style={{
              ...
              lineHeight: 1.5,
              margin: 0,
            }}>Sign up to unlock smart AI food searches.</p>
          </div>
          ...
          <AnimatePresence mode="wait">
            {isSuccess ? (
              ...
              >
                ...
                <h3 style={{ color: COLORS.cream, fontSize: 18, fontWeight: 700, marginBottom: 8 }}>Account Created!</h3>
                <p style={{ color: COLORS.muted, fontSize: 14 }}>Redirecting to Login...</p>
              </motion.div>
            ) : (
              <motion.form
              ...
              >
                {/* Full Name Field */}
                <div style={{ marginBottom: 16, transformStyle: "preserve-3d" }}>
                  ...
                  <div style={{
                    ...
                    <span style={{
                      ...
                      color: focusedField === "fullName" ? COLORS.brand : COLORS.muted,
                    ...
                    <input
                      ...
                      style={{
                        ...
                        background: focusedField === "fullName" ? "rgba(14, 11, 18, 0.8)" : "rgba(14, 11, 18, 0.4)",
                        border: `1.5px solid ${errors.fullName ? COLORS.error : (focusedField === "fullName" ? COLORS.brand : COLORS.rim)}`,
                        borderRadius: 14,
                        color: COLORS.white,
                        fontSize: 14,
                        outline: "none",
                        fontFamily: "inherit",
                        boxShadow: focusedField === "fullName" ? `0 0 15px ${COLORS.brand}18` : "none",
                  ...
                  {errors.fullName && (
                    <motion.p
                      ...
                      style={{ color: COLORS.error, fontSize: 12, marginTop: 4, fontWeight: 500 }}
                ...
                <div style={{ marginBottom: 16, transformStyle: "preserve-3d" }}>
                  <label htmlFor="signup-confirm" style={{
                    display: "block",
                    color: COLORS.cream,
                    fontSize: 13,
                    fontWeight: 600,
                  ...
                  <div style={{
                    ...
                    <span style={{
                      ...
                      top: "50%",
                      transform: "translateY(-50%)",
                      color: focusedField === "confirmPassword" ? COLORS.brand : COLORS.muted,
                      transition: "color 0.2s ease",
                      display: "flex",
                      alignItems: "center",
                    }}>
                    ...
                    <input
                      ...
                      style={{
                        width: "100%",
                        padding: "11px 16px 11px 44px",
                        background: focusedField === "confirmPassword" ? "rgba(14, 11, 18, 0.8)" : "rgba(14, 11, 18, 0.4)",
                        border: `1.5px solid ${errors.confirmPassword ? COLORS.error : (focusedField === "confirmPassword" ? COLORS.brand : COLORS.rim)}`,
                        borderRadius: 14,
                        color: COLORS.white,
                        fontSize: 14,
                        outline: "none",
                        fontFamily: "inherit",
                        boxShadow: focusedField === "confirmPassword" ? `0 0 15px ${COLORS.brand}18` : "none",
                        transition: "all 0.3s cubic-bezier(0.16, 1, 0.3, 1)",
                      }}
                ...
                <div style={{ marginBottom: 20, transformStyle: "preserve-3d" }}>
                  <label style={{
                    ...
                    <span>
                      I agree to the{" "}
                      <a href="#" onClick={(e) => { e.preventDefault(); alert("Terms & Conditions placeholder clicked!"); }} style={{ color: COLORS.brand, textDecoration: "none", fontWeight: 600 }}>Terms of Service</a>
                      {" "}and{" "}
                      <a href="#" onClick={(e) => { e.preventDefault(); alert("Privacy Policy placeholder clicked!"); }} style={{ color: COLORS.brand, textDecoration: "none", fontWeight: 600 }}>Privacy Policy</a>.
                    </span>
                  </label>
                  {errors.terms && (
                    <motion.p
                ...
                <div style={{
                  ...
                  <span style={{ color: COLORS.muted, fontSize: 11, fontWeight: 600, textTransform: "uppercase", letterSpacing: "0.05em" }}>or sign up with</span>
                  <div style={{ flex: 1, height: 1, background: COLORS.rim }} />
                </div>
                ...
                <div style={{
                  ...
                  {[
                    ...
                    <motion.button
                      ...
                      whileTap={{ scale: 0.96 }}
                      onClick={() => alert(`Sign up with ${p.name} placeholder clicked!`)}
                      style={{
                        padding: "12px",
